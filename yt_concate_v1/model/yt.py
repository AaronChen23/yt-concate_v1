...
class YT:
    ...
    def get_caption_filepath(self):
        # return os.path.join(CAPTIONS_DIR, self.get_video_id_from_url(self.url) + ".txt") #簡化成下列
        return os.path.join(CAPTIONS_DIR, self.id + ".txt")

    def get_video_filepath(self):
        # return os.path.join(VIDEOS_DIR, self.get_video_id_from_url(self.url) + ".txt")  #簡化成下列
